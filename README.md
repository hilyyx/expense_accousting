...
- Декоративная иконка кошелька (`QPixmap` + `QLabel`) для улучшения визуального оформления
...
- `PyQt6.QtGui` — для работы с изображениями (`QPixmap`)  
- `PyQt6.QtCore` — для работы с датами и сигналами  
- `sqlite3` — для работы с базой данных   
- `QTableWidget` — для отображения таблицы расходов  
- `QPixmap` — для загрузки и отображения декоративных изображений  

---

## 🧠 Используемые базовые виджеты PyQt6
- `QMainWindow`, `QWidget`  
- `QPushButton`, `QLineEdit`, `QComboBox`, `QDateEdit`, `QCheckBox`, `QLabel`  
- `QTableWidget`, `QMessageBox`  
- `QVBoxLayout`, `QHBoxLayout`, `QGridLayout`  
- `QPixmap` — для работы с изображениями (декоративные иконки)

---

## 🎨 Декоративные элементы
- Декоративные иконки для улучшения визуального оформления
- Иконка кошелька в окне авторизации (`res/wallet_icon.png`)
- Иконка денег в главном окне (`res/money_icon.png`)
- Изображения загружаются через `QPixmap` и автоматически масштабируются
- Если изображения отсутствуют, приложение работает без них
